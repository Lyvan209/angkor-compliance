-- ============================================================================
-- ANGKOR COMPLIANCE NUCLEAR DATABASE RESET (FIXED)
-- ============================================================================
...
-- Clean up auth-related tables (but keep users)
DELETE FROM auth.refresh_tokens;
DELETE FROM auth.sessions;

-- Drop any remaining triggers using information_schema
DO $$ 
DECLARE
    ...
    LOOP
        BEGIN
            EXECUTE format('DROP TRIGGER IF EXISTS %I ON %I.%I', 
                trigger_record.trigger_name, trigger_record.event_object_schema, trigger_record.event_object_table);
        EXCEPTION 
            WHEN OTHERS THEN 
                NULL;
        END;
