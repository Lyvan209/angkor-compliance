-- ============================================================================
-- ANGKOR COMPLIANCE COMPLETE DATABASE RESET
-- ============================================================================
-- This script combines cleanup and fresh setup in one file
-- ⚠️ WARNING: This will delete ALL data in your database!
-- 
-- Simply copy this ENTIRE script and paste it into Supabase SQL Editor
-- ============================================================================

-- ==============================================
-- PART 1: CLEANUP (Remove all leftover data)
-- ==============================================
...
-- Drop sequences, functions, and types
...
SELECT p.*, f.name as factory_name, EXTRACT(DAYS FROM p.expiry_date - CURRENT_DATE) as days_until_expiry
...
SELECT c.*, f.name as factory_name, u.full_name as assigned_to_name
...
COMMENT ON DATABASE postgres IS 'Angkor Compliance - Fresh Setup Complete';
