...
-- Supabase PostgreSQL Database for Cambodian Garment Factory Compliance Management
...
-- Factory access based on factory_users relationship
...
-- Permits accessible by factory members
...
-- Sequence for grievance numbers
...
COMMENT ON DATABASE postgres IS 'Angkor Compliance - Cambodian Garment Factory Compliance Management System'; 