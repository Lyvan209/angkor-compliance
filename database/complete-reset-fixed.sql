-- ============================================================================
-- ANGKOR COMPLIANCE COMPLETE DATABASE RESET (FIXED)
-- ============================================================================
...
-- Create views with FIXED date calculations
...
SELECT 'Database reset completed successfully! 🎉' AS status, 'All tables, policies, and storage buckets created.' AS details; 